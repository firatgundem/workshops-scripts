...
# Find which areas intersects with libraries and save as a variable called "intersects"

intersects <- st_intersects(areas, libraries) 
intersects

# Filter areas by *without* libraries. Save as a variable called "no_lib" Hint: use "==" instead if ">" in the logical comparison
...
ggsave("doc/areas_without_libraries.png")
...
#this is just to help me figure out of which columns to select
